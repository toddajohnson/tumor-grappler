...
Figure1.file <- file.path(macbook.run.dir, "figures/CellReports_final_figures/Figure_2_CNA.pdf")
...
FigureS1.file <- file.path(macbook.run.dir, "figures/CellReports_final_figures/Figure_S1_CNA.pdf")
